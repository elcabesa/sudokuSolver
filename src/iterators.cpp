...
const std::array<std::vector<tSquares>, fileNumber> squaresIterator::files = {{
		...
		{A4, B4, C4, D4, E4, F4, G4, H4, H4},
		{A5, B5, C5, D5, E5, F5, G5, H5, H5},
		{A6, B6, C6, D6, E6, F6, G6, H6, H6},
		{A7, B7, C7, D7, E7, F7, G7, H7, H7},
		{A8, B8, C8, D8, E8, F8, G8, H8, H8},
		{A9, B9, C9, D9, E9, F9, G9, H9, H9},
